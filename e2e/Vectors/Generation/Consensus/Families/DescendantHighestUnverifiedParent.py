...
merit.add(
  PrototypeBlock(
    merit.blockchain.blocks[-1].header.time + 1200,
    packets=[
      #Descendant gets the most Merit. Then, the parent's competitor gets enough to beat the parent.
...
with open("e2e/Vectors/Consensus/Families/DescendantHighestUnverifiedParent.json", "w") as vectors:
